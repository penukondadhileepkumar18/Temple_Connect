  ...
  <BaseCard class="w-full max-w-md mx-auto">
    ...
    <div v-if="emailSent" class="text-center space-y-6">
      ...
      <div class="bg-green-50 border border-green-200 rounded-xl p-6">
        ...
        <h3 class="text-lg font-semibold text-green-900 mb-2">Email Sent!</h3>
...
const errorMessage = ref('') // holds backend error message for inline display
...
const handleForgotPassword = async () => {
  ...
  errorMessage.value = '' // clear previous error before retrying
  ...
  try {
    ...
    if (result.success) {
      ...
      errorMessage.value = result.message || 'Failed to send reset instructions. Please try again.'
